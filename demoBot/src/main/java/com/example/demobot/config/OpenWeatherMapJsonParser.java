...
public class OpenWeatherMapJsonParser implements WeatherParser{
    ...
    private final static String API_KEY_TEMPLATE = "&units=metric&APPID=ee679dd0a9455b91e29f6f316f558e26&lang=ru";
        ...
        for (String line : weatherList) {
            {
                ...
                try {
                    ...
                    for (final JsonNode objNode : weatherArrNode) {
                        ...
                        sb.append(formatForecastData(dateTime, objNode.get("main").toString(), objNode.get("description").toString(), mainNode.get("temp").asDouble()));
                    }
                } catch (IOException e) {
                    e.printStackTrace();
                }
    ...
    private static String formatForecastData(String dateTime, String main, String description, double temperature) throws Exception {
        ...
        String formattedMain = main.replaceAll("\"", "");
        String formattedDescription = description.replaceAll("\"", "");

        String weatherIconCode = WeatherUtils.weatherIconsCodes.get(formattedMain);
